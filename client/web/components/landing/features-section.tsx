...
const features = [
  {
    ...
    description: "Continuously ingest events from GitHub, Slack, Jira, Notion, Google Docs, meetings, and calendars. Everything becomes memory.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Knowledge Graph",
    description: "Build connected relationships between people, projects, decisions, and architecture. Memory becomes interconnected instead of isolated.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Reasoning Engine",
    description: "Find evidence, connect relationships, understand timelines, generate explanations, and update memory. Answer questions through reasoning, not retrieval.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Plugin Architecture",
    description: "Build domain-specific intelligence layers. Engineering Brain, Research Brain, Startup Brain—every vertical becomes a plugin.",
    visual: "security",
  },
];
